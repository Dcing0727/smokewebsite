...
export default {
  data() {
    return {
      blogs: [
        { id: 1, title: '博客文章 1', summary: '这是第一篇博客文章的简介...' },
        { id: 2, title: '博客文章 2', summary: '这是第二篇博客文章的简介...' },
        { id: 3, title: '博客文章 3', summary: '这是第三篇博客文章的简介...' },
        { id: 4, title: '博客文章 4', summary: '这是第四篇博客文章的简介...' },
        { id: 5, title: '博客文章 5', summary: '这是第五篇博客文章的简介...' },
