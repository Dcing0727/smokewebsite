    ...
    methods: {
        formatDate(dateString) {
          ...
          fetchAuthorInfo() {
              ...
              const authorId = this.blog.authorId; // 或者 this.$route.params.authorId
              axios.get(`http://localhost:3000/api/user/${authorId}`)
                  .then(response => {
          ...
          fetchAuthorBlogs() {
              ...
              const authorId = this.blog.authorId; // 或者 this.$route.params.authorId
              axios.get(`http://localhost:3000/api/user/${authorId}/blogs`)
                  .then(response => {
